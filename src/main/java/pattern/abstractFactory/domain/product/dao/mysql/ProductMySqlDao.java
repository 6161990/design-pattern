...
public class ProductMySqlDao implements ProductDao {
    ...
    public String insertProduct(Product product) {
        return "insert into MYSQL DB productId =" + product.productId();
    }

    @Override
    public String updateProduct(Product product) {
        return "update into MYSQL DB productId =" + product.productId();
    }

    @Override
    public String deleteProduct(Product product) {
        return "delete into MYSQL DB productId =" + product.productId();
    }
}
